...
/**
 * {@link RecyclerView.Adapter} that can display a {@link CommentDto}
...
public class MyCommentRecyclerViewAdapter extends RecyclerView.Adapter<MyCommentRecyclerViewAdapter.ViewHolder> {
    ...
    private final List<CommentDto> mValues;

    public MyCommentRecyclerViewAdapter(List<CommentDto> items) {
        mValues = items;
    }
